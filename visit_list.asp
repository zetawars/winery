...
<!-- Main -->
	<div id="main">
        ...
        SQL = "SELECT * FROM qry_Vineyard_Favorites ORDER BY Vineyard_ID DESC, Winery_Name ASC "
       ...
       'Response.write SQL1
        ...
        <article class="post">
            <header>
                ...
                <div class="title2" style="margin-right: 30px">
                    ...
                    <h3><a class="published" href='vineyard_details.asp?V=<%=rsVineyard("ID")%>'><%=rsVineyard("Winery_Name")%></a></h3>
                    
                    <a target="_blank" href="https://www.google.com/maps/place/<% =GAdd2 %>"><span class="published"><% =Loca %></span></a>
                                
                    <br /><a href=""><img alt="winery visit" src='images/icon_planning.jpg' width="25" height="25" border="0" style="float: left; " /></a>
                    <br /><span class="published"><b>Visit Dates: </b></span><% response.write F_FavID %>
