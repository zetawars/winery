								...
								<article class="published">
										<header2>
                                            ...
                                            <%  If WTaste = True Then  %>
                                                ...
                                                <img alt="I had this before" src="images/icon_wine_glass_3.png" style="vertical-align: middle; margin-right: 5px;" height="13" width="13" /><a class="" href='wine_details.asp?V=<% =rsvWinesv("Winery_Number") %>&W=<% =rsvWinesv("ID") %>'><% =rsvWinesv("Vintage") %>&nbsp;<% =rsvWinesv("Name") %></a>
...
<!-- Database results for last 3 reviewed vines indicated as I want or I Bought -->
			                ...
			                <li>
				                <article>
					                ...
					                <a href="wine_details.asp?V=<% =rsWines("Vineyard") %>&W=<% =rsWines("Wine") %>" class="image"><img src='images/1-star.png'/></a>
				                </article>
			                </li>
