	...
	<script Language="JavaScript" Type="text/javascript"><!--
	    function FrontPage_Form1_Validator(theForm) {
	        ...
	        if (theForm.FName.value.length > 1) {
	            alert("Please enter at least 1 character in the \"FName\" field.");
	            theForm.FName.focus();
	            return (false);
	        }
...
<!-- Wrapper -->
	...
	<div id="main">
        ...
        <div class="title" style="background-color: #FFFFFF; padding-top: 60px; padding-bottom: 50px;">
            <header>
                <section>
	                <form style="margin: 50px" method="post" action="login_register.asp">

                    <span class="published">First Name*</span><br />
                    ...
                    <br /><br />
                        <span class="published">Password*</span><br />
