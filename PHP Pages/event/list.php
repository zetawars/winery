	...
	<div id="toys-grid"> 
        ...
        <thead>
          ...
          <tr>
                  ...
                  <?php
					echo "<td valign='top'>" . nl2br( $result[$k]['Name']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['E_Day']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['E_Date']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['E_Time']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Address']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Address_2']) . "</td>";  
					...
					echo "<td valign='top'>" . nl2br( $result[$k]['Cost']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Location']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Website']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Rating']) . "</td>";  
                  ?>  
					</tr>
					<?php
						}
