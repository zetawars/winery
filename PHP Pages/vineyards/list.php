...
if(!isset($_SESSION['username'])){
	...
	$sql = "SELECT * FROM Vineyards " . $queryCondition;
	$href = 'list.php';					
	...
	<div id="toys-grid"> 
        ...
        <thead>
					<tr>
                        ...
                        <th><strong>Winery_Name</strong></th> 
                        <th><strong>Winery_Logo</strong></th> 
                        <th><strong>Winery_Image</strong></th> 
                        <th><strong>Location</strong></th> 
                        <th><strong>Winery_Phone</strong></th> 
                        <th><strong>Website</strong></th> 
                        <th><strong>E_Mail</strong></th> 
                        <th><strong>Key_Amenities</strong></th> 
                        <th><strong>Restaurant</strong></th> 
                       
                        <th><strong>Hours</strong></th> 
                        <th><strong>Established</strong></th> 
                        <th><strong>Tastings</strong></th> 
                        <th><strong>Wine_Types</strong></th> 
          ...
          <tr>
                  ...
                  <?php
                    echo "<td>" . nl2br( $result[$k]['Winery_Name']) . "</td>";  
                    echo "<td><img alt='No hight='90' width='90' Image' src='" . nl2br( $result[$k]['Winery_Logo']) . "' /></td>";  
                    echo "<td><img alt='No hight='90' width='90' Image' src='" . nl2br( $result[$k]['Winery_Image']) . "'/></td>";  
                    echo "<td>" . nl2br( $result[$k]['Location']) . "</td>";  
                    echo "<td>" . nl2br( $result[$k]['Winery_Phone']) . "</td>";  
                    echo "<td>" . nl2br( $result[$k]['Website']) . "</td>";  
                    echo "<td>" . nl2br( $result[$k]['E_Mail']) . "</td>";  
                    echo "<td>" . nl2br( $result[$k]['Key_Amenities']) . "</td>";  
                    echo "<td>" . nl2br( $result[$k]['Restaurant']) . "</td>";  
                    echo "<td>" . nl2br( $result[$k]['Hours']) . "</td>";  
                    echo "<td>" . nl2br( $result[$k]['Established']) . "</td>";  
                    echo "<td>" . nl2br( $result[$k]['Tastings']) . "</td>";  
                    echo "<td>" . nl2br( $result[$k]['Wine_Types']) . "</td>";  
                    echo "<td>" . nl2br( $result[$k]['Trail']) . "</td>";  
