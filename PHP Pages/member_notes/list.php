...
if(!isset($_SESSION['username'])){
	...
	$sql = "SELECT * FROM Members_Notes " . $queryCondition;
	$href = 'list.php';					
	...
	<div id="toys-grid"> 
        ...
        <thead>
					<tr>
                        ...
                        <td><b>Wine Logo</b></td> 
                        <td><b>Winery</b></td> 
                        <td><b>Public Comments</b></td> 
                        <td><b>Private Comments</b></td> 
                        <td><b>User Like</b></td> 
                        <td><b>Tasting Score</b></td> 
                        <td><b>Computer Name</b></td> 
                        <td><b>TStamp</b></td> 
                        <td><b>UserN</b></td> 
                        <td><b>Publish Comments</b></td> 
					</tr>
				</thead>
				<tbody>
					<?php
          ...
          <tr>
                  ...
                  <?php
				  	echo "<td valign='top'>" . nl2br( $result[$k]['Member']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Wine']) . "</td>";  
					echo "<td valign='top'><img alt='No Logo' hight='100' width='100' src='" . nl2br( $result[$k]['Winery_Logo']) . "'/></td>";
					echo "<td valign='top'>" . nl2br( $result[$k]['Winery']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Public_Comments']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Private_Comments']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['User_Like']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Tasting_Score']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Computer_Name']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['TStamp']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['UserN']) . "</td>";  
					echo "<td valign='top'>" . nl2br( $result[$k]['Publish_Comments']) . "</td>";  
