...
<!-- Wrapper -->
	...
	<header id="header">
		<h1>
                ...
                <% else %>
                    <section><a href="boissetcollection.asp">Save Your Cork: BOISSET COLLECTION</a></section>
                <% end if %>
		</h1>
		<nav class="links">
	...
	<div id="main">
        ...
        'declare the SQL statement that will query the database
         SQL = "SELECT * FROM Vineyards WHERE Locale ='"&T&"' ORDER BY Winery_Name ASC "
       ...
       'Response.write SQL1
        ...
        Response.Write("No vineyards listed for this region.") 
        Else
				...
				<header>
					...
					<div class="title" style="margin-left: 20px">
					   ...
					   <h3>  
						...
						<br />
                        <% If rsVineyard("Winery_Phone") <> "Null" then %>
                            <span class="published"><b>Phone: </b><a href="tel:<%=rsVineyard("Winery_Phone")%>"><%=rsVineyard("Winery_Phone")%></a></span>
						<% end if %>
...
<!-- Sidebar -->
	...
	<!-- Intro -->
        ...
        <% else %>
		    ...
		    <section id="intro">
			    <a href="boissetcollection.asp" class="image featured" ><img src="images/boisset/BT_WineryImage_4_1200_675_65.jpg" alt="" /></a>
			    <header>
				    <span style="font-size: 37px; font-weight:bold; color:Black">The Boisset Collection</span>
		...
		<section>Some of my recent visits...
		    <div class="mini-posts">
		        ...
		        <ul class="actions">
                    ...
                    <% else %>
                        <li><a href="vineyard_list.asp" class="button big">View all of Boisset's wineries</a></li>
                    <% end if %>
		        </ul>
