<%
    If Session("loggedin") <> true Then
        Response.Redirect("login.asp?requester=dining_list.asp")
...
<!-- Main -->
	<div id="main">
        ...
        'declare the SQL statement that will query the database
         SQL = "SELECT * FROM Dining ORDER BY ID DESC"
        SQL1 = "SELECT * FROM Favorites WHERE Member_ID='"&M&"' ORDER BY Dining_ID DESC"
       'Response.write SQL1
        ...
        Loca =Left(rsDining("Address"),(InStrRev(rsDining("Address"),",") -1))
	    %>

        <article class="post">
            <header>
                <div class="title">
                    <a href='dining_details.asp?D=<%=rsDining("ID")%>' ><img width="300" alt="<%=rsDining("Restaurant")%>" src='<%=rsDining("Dining_Image")%>'  /></a>
                </div>
                <div class="title" style="margin-left: 20px">
                    ...
                    <h3>
                     ...
                     <% end if %>
                        <a class="published" href='dining_details.asp?D=<%=rsDining("ID")%>'><%=rsDining("Restaurant")%></a>
                    ...
                    <% if T_Rest > 6 then %>
	                    <br /><span class="published"><b>Winery: </b><a class="published" href='vineyard_details.asp?V=<%=rsDining("Vineyard_ID")%>'><%=rsDining("Vineyard")%></a></span>
