<%  
    ...
    If Session("loggedin") <> true Then
        Response.Redirect("login.asp?requester=boissetcollection.asp")
...
<html>
	<head>
		<title>Save Your Cork: Boisset Collection</title>
		<meta charset="utf-8" />
        ...
        <link rel="icon" href="https://my.boissetcollection.com/sites/default/files/favicon.ico" type="image/x-icon">
				...
				<!-- Header -->
					<header id="header">
						<h1>
                            ...
                            <% else %>
                                <a href="boissetcollection.asp">Boisset Collection</a>
                            <% end if %>
                        </h1>
				...
				<!-- Sidebar -->
					<section id="sidebar">
						...
						<!-- Mini Posts -->
                            ...
                            <% else %>
                                <section>Some Boisset favorites...
                            <% end if %>
								...
								<div class="mini-posts">
									...
									<!-- Mini Post -->
										<article class="mini-post">
                                            ...
                                            <!-- #include file="boisset_vineyard_qry_favorites.asp" -->
						...
						<!-- Footer -->
							<section id="footer">
								...
								<p class="copyright">&copy; Save Your Cork. Another fine website built by Chris Freeman. </p>
							</section>
